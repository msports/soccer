...
myApp.fixturesList = function (token) {
    ...
    $$.ajax({
        ...
        url: 'https://api.football-data.org/v1/competitions/445/fixtures?timeFrameStart=' + startDate + '&timeFrameEnd=' + endDate,
        dataType: 'json',
        type: 'GET',
